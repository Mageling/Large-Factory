...
public class VanillaCrafting {
    ...
    public static void registerVanillaCrafting() {
        CraftingHelper
        .addShapelessOreRecipe(new ItemStack(ModItems.saltPorkRaw, 1),
                new Object[] { "salt", Item.porkRaw });
        CraftingHelper.addShapelessOreRecipe(new ItemStack(
                ModItems.saltSteakRaw, 1),
                new Object[] { "salt", Item.beefRaw });
        CraftingHelper.addShapelessOreRecipe(new ItemStack(
                ModItems.saltChickenRaw, 1), new Object[] { "salt",
            Item.chickenRaw });
        CraftingHelper
        .addShapelessOreRecipe(new ItemStack(ModItems.saltFishRaw, 1),
                new Object[] { "salt", Item.fishRaw });
        CraftingHelper.addShapelessOreRecipe(new ItemStack(ModItems.saltFlesh,
                1), new Object[] { "salt", ModItems.salt, Item.rottenFlesh });
        GameRegistry
        .addRecipe(new ItemStack(ModBlocks.saltCondenser, 1),
                new Object[] { "G G", "PBP", "PCP", 'G', Block.glass,
            'P', Block.planks, 'B', Item.bucketEmpty, 'C',
            Block.chest });
        CraftingHelper.addShapelessOreRecipe(new ItemStack(ModItems.saltChunk),
                new Object[] { "salt", "salt", "salt", "salt", "salt", "salt",
            "salt", "salt" });
