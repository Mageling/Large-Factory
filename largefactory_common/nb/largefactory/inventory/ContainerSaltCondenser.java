...
public class ContainerSaltCondenser extends Container {
    ...
    public ContainerSaltCondenser(InventoryPlayer inventoryPlayer, TileEntitySaltCondenser saltCondenser) {
        ...
        this.addSlotToContainer(new SlotOutput(saltCondenser, TileEntitySaltCondenser.OUTPUT_INVENTORY_INDEX, 80, 36));
    ...
    public ItemStack transferStackInSlot(EntityPlayer entityPlayer, int slotIndex) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (slotIndex < TileEntitySaltCondenser.INVENTORY_SIZE) {
                ...
                if (!this.mergeItemStack(slotItemStack, TileEntitySaltCondenser.INVENTORY_SIZE, inventorySlots.size(),
                        false)) {
                    return null;
                }
            }
