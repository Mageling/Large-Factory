...
public class GeneralConfiguration {
    ...
    public static void init(File configFile) {
        ...
        try {
            ...
            Scalables.TEA_GROWTH_FACTOR = generalConfiguration.get(Strings.CONFIG_GENERAL_CATEGORY, Strings.CONFIG_TEA_GROWTH, Scalables.TEA_GROWTH_FACTOR_DEFAULT, "Percentage of normal growth rate, default is 100").getInt(Scalables.TEA_GROWTH_FACTOR_DEFAULT);
